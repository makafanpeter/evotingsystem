...
final class Index {
    ...
    const DEFAULT_PAGE = 'voter-login';
    const PAGE_DIR = '../page/';
    const LAYOUT_DIR = '../layout/';

    private static $validPages = array('voter-login', 'voter-home',
        'voter-result', 'voter-view', 'voter-edit', '404', '500');
    ...
    public function loadClass($name) {
        $classes = array(
            ...
            'ResultMapper' => '../mapper/ResultMapper.php',
    ...
    private function runPage($page, array $extra = array()) {
        ...
        if ($this->hasTemplate($page)) {
            ...
            require self::LAYOUT_DIR . 'voter.phtml';
        }
        if (!$run) {
