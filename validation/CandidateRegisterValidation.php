...
/**
 * Description of CandidateRegisterValidation
 *
 * @author Peter
 */
class CandidateRegisterValidation extends Validation implements Validator {
    //put your code here
    ...
    public static function validate(array $data) {
        ...
        if (!is_numeric($data['position_id'])) {
            $errors[] = new Error('position', 'Invalid position selected.');
        }
        return $errors;
    }
